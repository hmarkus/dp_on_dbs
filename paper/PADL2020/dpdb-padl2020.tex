...
Note that concrete implementations could generate and apply parts of the specification, as for example $\#\mathsf{localProbFilter}\#$, only for edges involving newly introduced vertices. %\todo{more detail}
