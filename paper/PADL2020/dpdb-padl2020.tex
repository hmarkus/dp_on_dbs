...
%
However, recently it was shown that for the better part~\cite{FichteHecherZisser19} of the
publicly available~\cSAT instances, techniques from 
parameterized complexity~\cite{FlumGrohe06,DowneyFellows13,Niedermeier06,CyganEtAl15} 
might come to the rescue. %rescue.
%
In particular, after using regular preprocessors, e.g., pmc~\cite{LagniezMarquis14}, in this area, 
more than 80\% of these practically relevant instances (graph representations thereof) 
have reasonably small treewidth,
where small treewidth is one of the most cited\footnote{On October 17, 2019, Google Scholar shows 19,200 results on treewidth. Treewidth was also subject of recent competitions~\cite{DellHusfeldtJansen17a,DellKomusiewiczTalmon18a}.} 
combinatorial invariants.
%
To be more concrete, the measure treewidth is a structural parameter of graphs,
which models the closeness of the graph to being a tree. 
%
This, gives rise to a general framework for counting problems
that leverage treewidth.
%
...
since the performance of database systems highly depend on query optimization. % and should know best, how to join.
...
the column for a vertex~$a$ is set o~$1$, i.e., vertex~$a$ is in the vertex cover,
...
results for~\cSAT with preprocessor pmc, respectively. %B+E, and without preprocessing, respectively.
%
%
%
%
...
\begin{table}[tb]
  ...
  \resizebox{0.8\columnwidth}{!}{%
    \begin{tabular}{{l|lH||rrrrrrrr||r||rHr}}
      ...
      \midrule
      \parbox[t]{1em}{\multirow{9}{*}{\rotatebox[origin=c]{90}{preprocessed by pmc}}}&miniC2D & \textbf{0} & 1193 & 29 & \textbf{10} & 2 & 1 & 7 & 13 & 0 & \textbf{1242} & \textbf{68.77} & 1 \\
